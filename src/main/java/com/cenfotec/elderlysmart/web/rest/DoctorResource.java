...
/**
 * REST controller for managing {@link com.cenfotec.elderlysmart.domain.Doctor}.
 */
@RestController
@RequestMapping("/api")
public class DoctorResource {
     ...
     */
    @GetMapping("/doctors")
    public List<Doctor> getAllDoctors(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
