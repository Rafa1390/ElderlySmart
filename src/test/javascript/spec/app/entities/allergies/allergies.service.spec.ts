...
describe('Service Tests', () => {
  describe('Allergies Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(AllergiesService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Allergies(0, 0, 'AAAAAAA', 'AAAAAAA');
    });
